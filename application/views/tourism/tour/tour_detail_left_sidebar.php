                        ...
                        <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9 content-side">
                            ...
                            <div class="detail-slider">
                                <div class="feature-slider">
                                    <div><img src="<?=INCLUDE_ASSETS?>images/t-feature-1.jpg" class="img-responsive" alt="feature-img"/></div>
                                    <div><img src="<?=INCLUDE_ASSETS?>images/t-feature-2.jpg" class="img-responsive" alt="feature-img"/></div>
                                    <div><img src="<?=INCLUDE_ASSETS?>images/t-feature-3.jpg" class="img-responsive" alt="feature-img"/></div>
                                    <div><img src="<?=INCLUDE_ASSETS?>images/t-feature-4.jpg" class="img-responsive" alt="feature-img"/></div>
                                    <div><img src="<?=INCLUDE_ASSETS?>images/t-feature-5.jpg" class="img-responsive" alt="feature-img"/></div>
                                </div><!-- end feature-slider -->
                            	
                                <div class="feature-slider-nav">
                                    <div><img src="<?=INCLUDE_ASSETS?>images/t-feature-thumb-1.jpg" class="img-responsive" alt="feature-thumb"/></div>
                                    <div><img src="<?=INCLUDE_ASSETS?>images/t-feature-thumb-2.jpg" class="img-responsive" alt="feature-thumb"/></div>
                                    <div><img src="<?=INCLUDE_ASSETS?>images/t-feature-thumb-3.jpg" class="img-responsive" alt="feature-thumb"/></div>
                                    <div><img src="<?=INCLUDE_ASSETS?>images/t-feature-thumb-4.jpg" class="img-responsive" alt="feature-thumb"/></div>
                                    <div><img src="<?=INCLUDE_ASSETS?>images/t-feature-thumb-5.jpg" class="img-responsive" alt="feature-thumb"/></div>
                            ...
                            <div class="detail-tabs">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div id="tour-information" class="tab-pane in active">
                                    	<div class="row">
                                    		<div class="col-sm-4 col-md-4 tab-img">
                                        		<img src="<?=INCLUDE_ASSETS?>images/hotel-detail-tab-1.jpg" class="img-responsive" alt="flight-detail-img" />
                                            </div><!-- end columns -->
                                    ...
                                    <div id="flight" class="tab-pane">
                                    	<div class="row">
                                    		<div class="col-sm-4 col-md-4 tab-img">
                                        		<img src="<?=INCLUDE_ASSETS?>images/hotel-detail-tab-2.jpg" class="img-responsive" alt="flight-detail-img" />
                                            </div><!-- end columns -->
                                    ...
                                    <div id="map-overview" class="tab-pane">
                                    	<div class="row">
                                    		<div class="col-sm-4 col-md-4 tab-img">
                                        		<img src="<?=INCLUDE_ASSETS?>images/hotel-detail-tab-3.jpg" class="img-responsive" alt="flight-detail-img" />
                                            </div><!-- end columns -->
                            ...
                            <div class="available-blocks" id="available-tours">
                                    ...
                                    <div class="list-content">
                                        <div class="main-img list-img t-list-img">
                                            <a href="tour-detail-left-sidebar.html">
                                                <img src="<?=INCLUDE_ASSETS?>images/tour-list-1.jpg" class="img-responsive" alt="tour-img" />
                                            </a>
                                            <div class="main-mask">
                                ...
                                <div class="list-block main-block t-list-block">
                                    <div class="list-content">
                                        <div class="main-img list-img t-list-img">
                                            <a href="tour-detail-left-sidebar.html">
                                                <img src="<?=INCLUDE_ASSETS?>images/tour-list-2.jpg" class="img-responsive" alt="tour-img" />
                                            </a>
                                            <div class="main-mask">
                                                <ul class="list-unstyled list-inline offer-price-1">
                                                    <li class="price">$568.00<span class="divider">|</span><span class="pkg">7 Days Tour</span></li>
                                ...
                                <div class="list-block main-block t-list-block">
                                    <div class="list-content">
                                        <div class="main-img list-img t-list-img">
                                            <a href="tour-detail-left-sidebar.html">
                                                <img src="<?=INCLUDE_ASSETS?>images/tour-list-3.jpg" class="img-responsive" alt="tour-img" />
                                            </a>
                                            <div class="main-mask">
                                                <ul class="list-unstyled list-inline offer-price-1">
                                                    <li class="price">$568.00<span class="divider">|</span><span class="pkg">7 Days Tour</span></li>
                                ...
                                <div class="list-block main-block t-list-block">
                                    <div class="list-content">
                                        <div class="main-img list-img t-list-img">
                                            <a href="tour-detail-left-sidebar.html">
                                                <img src="<?=INCLUDE_ASSETS?>images/tour-list-4.jpg" class="img-responsive" alt="tour-img" />
                                            </a>
                                            <div class="main-mask">
                                                <ul class="list-unstyled list-inline offer-price-1">
                                                    <li class="price">$568.00<span class="divider">|</span><span class="pkg">7 Days Tour</span></li>
