...
<html lang="en">
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                <li class="dropdown active"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Home<span><i class="fa fa-angle-down"></i></span></a>
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="active"><a href="#">Hotel Homepage</a></li>
	...
	height:100%;">
                        ...
                        <div class="owl-carousel owl-theme owl-custom-arrow" id="owl-hotel-offers">
                                ...
                                <div class="main-block hotel-block">
                                    <div class="main-img">
                                    	<a href="hotel-detail-right-sidebar.html">
                                        	<img src="<?=INCLUDE_ASSETS?>images/hotel-1.jpg" class="img-responsive" alt="hotel-img" />
                                        </a>
                                        <div class="main-mask">
                            ...
                            <div class="item">
                                <div class="main-block hotel-block">
                                    <div class="main-img">
                                    	<a href="hotel-detail-right-sidebar.html">
                                        	<img src="<?=INCLUDE_ASSETS?>images/hotel-2.jpg" class="img-responsive" alt="hotel-img" />
                                        </a>
                                        <div class="main-mask">
                                        	<ul class="list-unstyled list-inline offer-price-1">
                                            	<li class="price">$568.00<span class="divider">|</span><span class="pkg">Avg/Night</span></li>
                            ...
                            <div class="item">
                                <div class="main-block hotel-block">
                                    <div class="main-img">
                                    	<a href="hotel-detail-right-sidebar.html">
                                        	<img src="<?=INCLUDE_ASSETS?>images/hotel-3.jpg" class="img-responsive" alt="hotel-img" />
                                        </a>
                                        <div class="main-mask">
                                        	<ul class="list-unstyled list-inline offer-price-1">
                                            	<li class="price">$568.00<span class="divider">|</span><span class="pkg">Avg/Night</span></li>
                            ...
                            <div class="item">
                                <div class="main-block hotel-block">
                                    <div class="main-img">
                                        <a href="hotel-detail-right-sidebar.html">
                                        	<img src="<?=INCLUDE_ASSETS?>images/hotel-4.jpg" class="img-responsive" alt="hotel-img" />
                                        </a>
                                        <div class="main-mask">
                                        	<ul class="list-unstyled list-inline offer-price-1">
                                            	<li class="price">$568.00<span class="divider">|</span><span class="pkg">Avg/Night</span></li>
        			...
        			<div class="col-sm-12 col-md-12 col-lg-6 luxury-img luxury-room-imgs">
                        <div class="row">
                        	<div class="col-xs-6 col-sm-6 luxury-room-block">
                            	<a href="<?=INCLUDE_ASSETS?>images/luxury-room-1.jpg" title="image-7" class="with-caption gallery image-link">
                                <img class="img-responsive" src="images/luxury-room-1.jpg" alt="luxury-room-img">
                                </a>
                            </div>
                            
                            <div class="col-xs-6 col-sm-6 luxury-room-block">
                            	<a href="<?=INCLUDE_ASSETS?>images/luxury-room-2.jpg" title="image-7" class="with-caption gallery image-link">
                                <img class="img-responsive" src="images/luxury-room-2.jpg" alt="luxury-room-img">
                                </a>
                            </div>
                            
                            <div class="col-xs-6 col-sm-6 luxury-room-block">
                            	<a href="<?=INCLUDE_ASSETS?>images/luxury-room-3.jpg" title="image-7" class="with-caption gallery image-link">
                                <img class="img-responsive" src="images/luxury-room-3.jpg" alt="luxury-room-img">
                                </a>
                            </div>
                            
                            <div class="col-xs-6 col-sm-6 luxury-room-block">
                            	<a href="<?=INCLUDE_ASSETS?>images/luxury-room-4.jpg" title="image-7" class="with-caption gallery image-link">
                                <img class="img-responsive" src="<?=INCLUDE_ASSETS?>images/luxury-room-4.jpg" alt="luxury-room-img">
                                </a>
                            </div>
                        </div>
        ...
        <script src="<?=INCLUDE_ASSETS?>js/jquery.magnific-popup.min.js"></script>
        ...
        <script src="<?=INCLUDE_ASSETS?>js/custom-gallery.js"></script>
        <!-- Page Scripts Ends -->
