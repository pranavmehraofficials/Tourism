                        	...
                        	<div class="flex-content">
                                <div class="custom-form custom-form-fields">
                                    ...
                                    <form method="post" onsubmit="return checkValidation()">
                                        ...
                                        <button type="submit" name="register" class="btn btn-orange btn-block">Register</button>
                                    </form>
                                    
                                    <div class="other-links">
                                    	<p class="link-line">Already Have An Account ? <a href="<?=base_url()?>login">Login Here</a></p>
                                    </div><!-- end other-links -->
                                </div><!-- end custom-form -->
                                
                                <div class="flex-content-img custom-form-img">
                                    <img src="<?=INCLUDE_ASSETS?>images/registration.jpg" class="img-responsive" alt="registration-img" />
