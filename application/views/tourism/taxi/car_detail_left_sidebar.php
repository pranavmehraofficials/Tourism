                        ...
                        <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9 content-side">
                            ...
                            <div class="detail-slider">
                                <div class="feature-slider">
                                    <div><img src="<?=INCLUDE_ASSETS?>images/car-feature-1.jpg" class="img-responsive" alt="feature-img"/></div>
                                    <div><img src="<?=INCLUDE_ASSETS?>images/car-feature-2.jpg" class="img-responsive" alt="feature-img"/></div>
                                    <div><img src="<?=INCLUDE_ASSETS?>images/car-feature-3.jpg" class="img-responsive" alt="feature-img"/></div>
                                    <div><img src="<?=INCLUDE_ASSETS?>images/car-feature-4.jpg" class="img-responsive" alt="feature-img"/></div>
                                    <div><img src="<?=INCLUDE_ASSETS?>images/car-feature-5.jpg" class="img-responsive" alt="feature-img"/></div>
                                </div><!-- end feature-slider -->
                            	
                                <div class="feature-slider-nav">
                                    <div><img src="<?=INCLUDE_ASSETS?>images/car-feature-thumb-1.jpg" class="img-responsive" alt="feature-thumb"/></div>
                                    <div><img src="<?=INCLUDE_ASSETS?>images/car-feature-thumb-2.jpg" class="img-responsive" alt="feature-thumb"/></div>
                                    <div><img src="<?=INCLUDE_ASSETS?>images/car-feature-thumb-3.jpg" class="img-responsive" alt="feature-thumb"/></div>
                                    <div><img src="<?=INCLUDE_ASSETS?>images/car-feature-thumb-4.jpg" class="img-responsive" alt="feature-thumb"/></div>
                                    <div><img src="<?=INCLUDE_ASSETS?>images/car-feature-thumb-5.jpg" class="img-responsive" alt="feature-thumb"/></div>
                            ...
                            <div class="detail-tabs">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div id="car-information" class="tab-pane in active">
                                    	<div class="row">
                                    		<div class="col-sm-4 col-md-4 tab-img">
                                        		<img src="<?=INCLUDE_ASSETS?>images/car-detail-tab-1.jpg" class="img-responsive" alt="flight-detail-img" />
                                            </div><!-- end columns -->
                                    ...
                                    <div id="cr-features" class="tab-pane">
                                    	<div class="row">
                                    		<div class="col-sm-4 col-md-4 tab-img">
                                        		<img src="<?=INCLUDE_ASSETS?>images/car-detail-tab-2.jpg" class="img-responsive" alt="flight-detail-img" />
                                            </div><!-- end columns -->
                                    ...
                                    <div id="rental-info" class="tab-pane">
                                    	<div class="row">
                                    		<div class="col-sm-4 col-md-4 tab-img">
                                        		<img src="<?=INCLUDE_ASSETS?>images/car-detail-tab-3.jpg" class="img-responsive" alt="flight-detail-img" />
                                            </div><!-- end columns -->
                            ...
                            <div class="available-blocks" id="available-cars">
                                    ...
                                    <div class="list-content">
                                        <div class="main-img list-img cr-list-img">
                                            <a href="car-detail-left-sidebar.html">
                                                <img src="<?=INCLUDE_ASSETS?>images/car-list-1.jpg" class="img-responsive" alt="car-img" />
                                            </a>
                                            <div class="main-mask">
                                ...
                                <div class="list-block main-block cr-list-block">
                                    <div class="list-content">
                                        <div class="main-img list-img cr-list-img">
                                            <a href="car-detail-left-sidebar.html">
                                                <img src="<?=INCLUDE_ASSETS?>images/car-list-2.jpg" class="img-responsive" alt="car-img" />
                                            </a>
                                            <div class="main-mask">
                                                <ul class="list-unstyled list-inline offer-price-1">
                                                    <li class="price">$1250.00<span class="divider">|</span><span class="pkg">7 Days Tour</span></li>
                                ...
                                <div class="list-block main-block cr-list-block">
                                    <div class="list-content">
                                        <div class="main-img list-img cr-list-img">
                                            <a href="car-detail-left-sidebar.html">
                                                <img src="<?=INCLUDE_ASSETS?>images/car-list-3.jpg" class="img-responsive" alt="car-img" />
                                            </a>
                                            <div class="main-mask">
                                                <ul class="list-unstyled list-inline offer-price-1">
                                                    <li class="price">$1250.00<span class="divider">|</span><span class="pkg">7 Days Tour</span></li>
                                ...
                                <div class="list-block main-block cr-list-block">
                                    <div class="list-content">
                                        <div class="main-img list-img cr-list-img">
                                            <a href="car-detail-left-sidebar.html">
                                                <img src="<?=INCLUDE_ASSETS?>images/car-list-4.jpg" class="img-responsive" alt="car-img" />
                                            </a>
                                            <div class="main-mask">
                                                <ul class="list-unstyled list-inline offer-price-1">
                                                    <li class="price">$1250.00<span class="divider">|</span><span class="pkg">7 Days Tour</span></li>
