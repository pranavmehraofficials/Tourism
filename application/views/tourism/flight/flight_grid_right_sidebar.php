...
<html lang="en">
    <head>
		...
		<link rel="stylesheet" href="<?=INCLUDE_ASSETS?>css/jquery-ui.min.css">
    </head>
    ...
    <body>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <ul class="breadcrumb">
                            <li><a href="#">Home</a></li>
                            <li class="active">Flight Grid Right Sidebar</li>
                        </ul>
                    </div><!-- end columns -->
                </div><!-- end row -->
            </div><!-- end container -->
                            		...
                            		<div class="grid-block main-block f-grid-block">
                                        ...
                                        <div class="block-info f-grid-info">
                                        	<div class="f-grid-desc">
                                                ...
                                                <h3 class="block-title"><a href="flight-detail-right-sidebar.html">Sydney to Paris</a></h3>
                                            ...
                                            <div class="grid-btn">
                                            	<a href="flight-detail-right-sidebar.html" class="btn btn-orange btn-block btn-lg">View More</a>
                                            </div><!-- end grid-btn -->
                                        </div><!-- end f-grid-info -->
        ...
        <script src="<?=INCLUDE_ASSETS?>js/jquery-ui.min.js"></script>
        <script src="<?=INCLUDE_ASSETS?>js/bootstrap.min.js"></script>
        <script src="<?=INCLUDE_ASSETS?>js/custom-navigation.js"></script>
		<script src="<?=INCLUDE_ASSETS?>js/custom-price-slider.js"></script>
        <!-- Page Scripts Ends -->
    </body>
</html>
