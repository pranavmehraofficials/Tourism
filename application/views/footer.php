            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3 footer-widget ftr-contact">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><span><i class="fa fa-envelope"></i></span>info@bharattourism.com</li>
                    </ul>
                </div><!-- end columns -->
                ...
                <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3 footer-widget ftr-links ftr-pad-left">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><a href="<?=base_url()?>index">Site Map</a></li>
                    </ul>
                </div><!-- end columns -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6" id="copyright">
                    <p>© 2018 <a href="#">Bharat Tourism</a>. All rights reserved.</p>
                </div><!-- end columns -->
...
<script src="<?=INCLUDE_ASSETS?>js/custom-video.js"></script>
<!-- Page Scripts Ends -->